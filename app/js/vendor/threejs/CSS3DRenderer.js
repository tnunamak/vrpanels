...
THREE.CSS3DRenderer = function (parameters) {
    ...
    this.setViewport = function ( x, y, width, height ) {
        ...
        domElement.style.left = viewportX + 'px';
        domElement.style.top = viewportY + 'px';

        cameraElement.style.left = viewportX + 'px';
        cameraElement.style.top = viewportY + 'px';

        domElement.style.width = viewportWidth + 'px';
        domElement.style.height = viewportHeight + 'px';

        cameraElement.style.width = viewportWidth + 'px';
        cameraElement.style.height = viewportHeight + 'px';
